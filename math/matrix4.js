...
Matrix4.prototype = {
    ...
    makeOrthographic: function(left, right, top, bottom, near, far) {
        ...
        var e = this.elements;
        var rightMinusLeft = 1.0 / (right - left);
        var topMinusBottom = 1.0 / (top - bottom);
        var nearMinusFar = 1.0 / (near - far);

        e[0] = 2.0 * rightMinusLeft;
        e[5] = 2.0 * topMinusBottom;
        e[10] = 2.0 * nearMinusFar;
        e[12] = (right + left) * rightMinusLeft;
        e[13] = (top + bottom) * topMinusBottom;
